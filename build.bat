...
set objdump_=C:\Users\gaste\Downloads\xpack-riscv-none-elf-gcc-12.2.0-3-win32-x64\xpack-riscv-none-elf-gcc-12.2.0-3\bin\riscv-none-elf-objdump
...
%objdump_% -D out/result.elf > out/dis.S